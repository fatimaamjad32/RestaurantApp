...
public class BurgerActivity extends AppCompatActivity {
    ...
    FloatingActionButton addburgerfab;
    FirestoreRecyclerAdapter<FoodModel, BurgerActivity.FoodViewHolder> noteAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rvburger);
        ...
        addburgerfab = findViewById(R.id.addburgerfab);
        addburgerfab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(BurgerActivity.this, AddBurgerActivity.class);
                startActivity(i);
        ...
        noteAdapter = new FirestoreRecyclerAdapter<FoodModel, BurgerActivity.FoodViewHolder>(allburgeritems) {
            @Override
            protected void onBindViewHolder(@NonNull BurgerActivity.FoodViewHolder holder, int position, @NonNull FoodModel model) {
                        ...
                        popupMenu.getMenu().add("delete").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(@NonNull MenuItem menuItem) {
                                ...
                                DocumentReference documentReference = firebaseFirestore.collection("Burgers").
                                        document("iDIKIApKGbUx1XaUY3fS").collection("subcollection").document(docId);
                                documentReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(BurgerActivity.this, "note deleted successfully", Toast.LENGTH_SHORT).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(BurgerActivity.this, "note deletion filed", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                return false;
                            }
            ...
            @NonNull
            @Override
            public BurgerActivity.FoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View views = LayoutInflater.from(parent.getContext()).inflate(R.layout.popular2, parent, false);
                return new BurgerActivity.FoodViewHolder(views);
            }
    ...
    private void editBurger(FoodModel foodModel, String docId) {
        Intent intent = new Intent(this, EditBurgerActivity.class);
