    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnburgersave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DocumentReference documentReference = firebaseFirestore.collection("Drinks")
                        .document("w7EZzyVucp4qlHdgE00v").collection("subcollection").document(burgerId);
        ...
        btnburgerpic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Dexter.withContext(EditDrinkActivity.this)
        ...
        if (selectedImageUri != null) {
            ...
            ref.putFile(selectedImageUri)
                    .addOnSuccessListener(taskSnapshot -> ref.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        Toast.makeText(EditDrinkActivity.this, "Image Uploaded!!", Toast.LENGTH_SHORT).show();
                    }))
                    .addOnFailureListener(e -> {
                        if (!isFinishing() && progressDialog.isShowing()) {
                            progressDialog.dismiss();
                        }
                        Toast.makeText(EditDrinkActivity.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
}