...
public class Popular extends AppCompatActivity {
    ...
    FloatingActionButton addpopularfab;
    FirestoreRecyclerAdapter<FoodModel, Popular.FoodViewHolder> noteAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addpopularfab = findViewById(R.id.addpopularfab);
        addpopularfab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Popular.this, AddPopular.class);
                startActivity(i);
        ...
        noteAdapter = new FirestoreRecyclerAdapter<FoodModel, Popular.FoodViewHolder>(allburgeritems) {
            @Override
            protected void onBindViewHolder(@NonNull Popular.FoodViewHolder holder, int position, @NonNull FoodModel model) {
                            ...
                            public boolean onMenuItemClick(@NonNull MenuItem menuItem) {
                                ...
                                documentReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(Popular.this, "note deleted successfully", Toast.LENGTH_SHORT).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(Popular.this, "note deletion filed", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                return false;
                            }
            ...
            @NonNull
            @Override
            public Popular.FoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View views = LayoutInflater.from(parent.getContext()).inflate(R.layout.popular2, parent, false);
                return new Popular.FoodViewHolder(views);
            }
    ...
    private void editBurger(FoodModel foodModel, String docId) {
        Intent intent = new Intent(this, EditPopularActivity.class);
