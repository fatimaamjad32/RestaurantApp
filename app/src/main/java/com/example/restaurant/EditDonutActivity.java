...
public class EditDonutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_donut);
        ...
        btnburgersave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DocumentReference documentReference = firebaseFirestore.collection("Donuts")
                        .document("Ccv508udxf8e7p69yAJE").collection("subcollection").document(burgerId);
        ...
        btnburgerpic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Dexter.withContext(EditDonutActivity.this)
        ...
        if (selectedImageUri != null) {
            ...
            ref.putFile(selectedImageUri)
                    .addOnSuccessListener(taskSnapshot -> ref.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        Toast.makeText(EditDonutActivity.this, "Image Uploaded!!", Toast.LENGTH_SHORT).show();
                    }))
                    .addOnFailureListener(e -> {
                        if (!isFinishing() && progressDialog.isShowing()) {
                            progressDialog.dismiss();
                        }
                        Toast.makeText(EditDonutActivity.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
}