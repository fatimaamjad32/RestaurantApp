...
public class EditDealsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnburgersave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DocumentReference documentReference = firebaseFirestore.collection("Deals")
                        .document("YVGmwDdGTfsYZ7djongn").collection("subcollection").document(burgerId);
        ...
        btnburgerpic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Dexter.withContext(EditDealsActivity.this)
        ...
        if (selectedImageUri != null) {
            ...
            ref.putFile(selectedImageUri)
                    .addOnSuccessListener(taskSnapshot -> ref.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        Toast.makeText(EditDealsActivity.this, "Image Uploaded!!", Toast.LENGTH_SHORT).show();
                    }))
                    .addOnFailureListener(e -> {
                        if (!isFinishing() && progressDialog.isShowing()) {
                            progressDialog.dismiss();
                        }
                        Toast.makeText(EditDealsActivity.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
}