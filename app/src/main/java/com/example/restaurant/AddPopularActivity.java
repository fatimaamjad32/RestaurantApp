...
public class AddPopularActivity extends AppCompatActivity {

    StorageReference storageReference;

    EditText populartitle,populardescription,popularfee;
    Button popularpic,popularsave;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        popularpic=findViewById(R.id.popularpic);
        popularsave=findViewById(R.id.popularsave);
        ...
        popularpic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Dexter.withContext(AddPopularActivity.this)
        ...
        popularsave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        if (selectedImageUri != null) {
            ...
            ref.putFile(selectedImageUri)
                    .addOnSuccessListener(taskSnapshot -> ref.getDownloadUrl().addOnSuccessListener(uri -> {
                        ...
                        Toast.makeText(AddPopularActivity.this, "Image Uploaded!!", Toast.LENGTH_SHORT).show();
                    }))
                    .addOnFailureListener(e -> {
                        if (!isFinishing() && progressDialog.isShowing()) {
                            progressDialog.dismiss();
                        }
                        Toast.makeText(AddPopularActivity.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
}