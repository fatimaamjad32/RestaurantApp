...
public class PastaActivity extends AppCompatActivity {
    ...
    FloatingActionButton addpastafab;
    private static final int EDIT_CODE = 1;
    FirestoreRecyclerAdapter<FoodModel,PastaActivity.FoodViewHolder> noteAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.rvpasta);
        firebaseAuth = FirebaseAuth.getInstance();
        firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
        firebaseFirestore = FirebaseFirestore.getInstance();

        addpastafab = findViewById(R.id.addpastafab);
        addpastafab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(PastaActivity.this, AddPastaActivity.class);
                startActivity(i);
        ...
        noteAdapter = new FirestoreRecyclerAdapter<FoodModel, PastaActivity.FoodViewHolder>(allburgeritems) {
            @Override
            protected void onBindViewHolder(@NonNull PastaActivity.FoodViewHolder holder, int position, @NonNull FoodModel model) {
                    ...
                    public void onClick(View view) {
                        ...
                        popupMenu.getMenu().add("delete").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(@NonNull MenuItem menuItem) {
                                ...
                                DocumentReference documentReference=firebaseFirestore.collection("Pastas").document("RBZutOiSl2pPNYn3UbYz").collection("subcollection").document(docId);
                                documentReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(PastaActivity.this, "note deleted successfully", Toast.LENGTH_SHORT).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(PastaActivity.this, "note deletion filed", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                return false;
                            }
            ...
            @NonNull
            @Override
            public PastaActivity.FoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View views = LayoutInflater.from(parent.getContext()).inflate(R.layout.popular2, parent, false);
                return new PastaActivity.FoodViewHolder(views);
            }
    ...
    private void editBurger(FoodModel foodModel, String docId) {
        Intent intent = new Intent(this, EditPastaActivity.class);
